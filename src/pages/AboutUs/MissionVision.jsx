      ...
      <div className=" max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10 border-t-2 border-[#C49E5F]">
        <div className="md:w-2/3">
          ...
          <div className=" text-black text-xl lg:w-2/3 mt-0 tracking-normal font-medium">
            ...
            animi explicabo veniam? Blanditiis perferendis, nesciunt cupiditate
            alias praesentium id iure sequi, consequuntur placeat qui nostrum
            quae quidem voluptatum beatae aspernatur! Lorem ipsum dolor sit
            amet, consectetur adipisicing elit. Similique animi explicabo
            veniam? Blanditiis perferendis, nesciunt cupiditate alias
            praesentium id iure sequi, consequuntur placeat qui nostrum quae
            quidem voluptatum beatae aspernatur!
          </div>
        </div>
