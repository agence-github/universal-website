...
function Questions({ question, answer }) {
  ...
  return (
    <div className="flex flex-col items-stretch max-w-6xl mx-auto bg-[#C49E5F]/30 rounded-md shadow-md p-4">
      <div className="flex items-center justify-between">
        <h1 className="flex-1 font-regular text-lg lg:text-2xl p-4">
          {question}
        </h1>
        <button
          className="text-5xl transition-transform transform-gpu hover:scale-110"
